...
// Feedback post-acción
    LaunchedEffect(viewModel.isSuccess) {
        if (viewModel.isSuccess) {
            ...
            // Puedes limpiar campos aquí si quieres
        }
    }
    ...
    // Asignar lista de membresías al ViewModel de pagos
    ...
    Scaffold(
        ...
        Column(
            ...
            // Actualiza el monto en "Mixto" automáticamente
                ...
                onClick = {
                    ...
                    if (user != null && membership != null) {
                        val monto = when (paymentState.type) {
                            "Dólares" -> paymentState.amountDollar.toDoubleOrNull() ?: 0.0
                            "Bolívares" -> paymentState.amountBs.toDoubleOrNull() ?: 0.0
                            "Mixto" -> {
                                val montoUsd = paymentState.amountDollar.toDoubleOrNull() ?: 0.0
